...
%% relatively unconstraint apart from the identifiers.  The focus now
%% is mostly on streamlining message flow between Erlang and
%% JavaScript.  A separate library could be constructed to create
%% layout.
